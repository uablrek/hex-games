...
/*
  ...
  All are optional. Color/stroke will be overridden by nat+scheme.
...
import { X, setStrokeX } from './textbox.js'
// we should avoid dependencies to the map
...
function createUnit(obj = {}) {
	...
	if ('nat' in obj && obj.nat in nations) {
		...
		if ('stroke' in nations[obj.nat]) conf.stroke = nations[obj.nat].stroke
	}
...
export class UnitBox {
	...
	constructor(obj = {}) {
		...
		let height = this.rows * this.#sizeR + this.#offsetY
