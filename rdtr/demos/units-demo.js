...
/*
  ...
  The PDF counter sheets were imported to Gimp and converted to PNG,
...
export const units = [
	...
	{sheet:sheet.va, pos:{x:1,y:4}, type:"nav", nat:"nu", s:2},
	{sheet:sheet.uk, pos:{x:8,y:7}, type:"bh", nat:"nu", color:'white', stroke:'black'},
	{sheet:sheet.uk, pos:{x:8,y:7}, type:"bh", nat:"nu", color:'white', stroke:'black'},
	{sheet:sheet.uk, pos:{x:8,y:7}, type:"bh", nat:"nu", color:'white', stroke:'black'},
	{sheet:sheet.uk, pos:{x:8,y:7}, type:"bh", nat:"nu", color:'white', stroke:'black'},
	{sheet:sheet.uk, pos:{x:8,y:7}, type:"bh", nat:"nu", color:'white', stroke:'black'},
...
function byIndex() {
	...
	let maxRow = Math.round(units.length / 20)
	for (const [i, u] of units.entries()) {
